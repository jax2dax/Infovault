...
export default function DocEvaluate() {
  const EvaluationList = [
    ...
    { id: 2, title: "W.E.S", category: "Technology", date: "2025-11-04", link:redirect,url:"https://www.wes.org/resource-library/blog/credential-advice/the-wes-credential-evaluation-process-explained/" }
  ];
  function redirect(){() => window.open(info.url)}
 ...
 function gotoDocEvBasics(){
  ...
  return (
    <div className="info-container">
      <title>Document Evaluation & Assessment | How Our Review Process Works</title>
      <meta name="Complete Guidance, Walk through and full information about credentials,and its cross-country process "></meta>
